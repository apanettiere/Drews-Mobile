        ...
        <div className="grid sm:grid-cols-2 place-items-center gap-8">
          ...
          <div className="pl-5">
            ...
            <p className="text-sm leading-7  mb-5">
              ...
              Polish gives your vehicle a great shine and removes those annoying
              spiderweb scratches. When you get a polish service, we always put
              a beautiful coat of wax on after for free! It will break down the
              clear coat of your paint (to remove the dull look and scratches),
              and the wax will add a layer of protection to your paint. A
              one-step polish process is for vehicles that have very light
              scratches and a slight dull look. A two-step polish is for a
              vehicle that has many light to medium scratches and a dull look.
              
              Prices may vary slightly due to the size of the vehicle. Call or
              text for estimates
              <br />
          ...
          <div className="pl-5">
            ...
            <p className="text-sm leading-7 mb-5">
              ...
              the best and longest-lasting product. I use two products rated for
              7 and 9 years! A graphene ceramic coat is basically a layer of
              glass applied to your paint. This process takes 6-9 hours and
              requires the car to be in the best condition possible before
              applying. A ceramic coat includes a wash, clay bar, polish, prep
              spray, then the graphene ceramic coat is applied. The coating can
              also be applied to glass and rims upon request. Your car will look
              brand new and protected for many years! You can also coat the
              interior! We use specialized ceramic coatings for leather,
              plastics, and vinyls and are rated for two years of protection.
              Pricing will be determined by the condition of the vehicle and by
              size.
            </p>
          </div>
        </div>
